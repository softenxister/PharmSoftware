...
export function TopBar({ activeNav, onNavChange }: TopBarProps) {
    ...
    >
      ...
      <div className="flex items-center h-full">
        ...
        <div className="flex items-center gap-2.5 pr-5 mr-2" style={{ borderRight: "1px solid #354e3e" }}>
          ...
          <div>
            <p style={{ color: "#f0f7f3", fontSize: "15.6px", fontWeight: 700, letterSpacing: "0.03em", lineHeight: 1 }}>RxPro</p>
        ...
        {navItems.map(({ label, icon: Icon }) => {
          ...
          return (
            <button
              ...
              className="flex items-center gap-2 px-4 h-full transition-colors"
              style={{
            ...
            >
              <Icon size={16.8} strokeWidth={isActive ? 2.2 : 1.8} />
