...
export type AuthSessionCreateInput = {
  ...
  account: Prisma.PharmAccountCreateNestedOneWithoutSessionsInput
}
...
export type AuthSessionUpdateInput = {
  ...
  account?: Prisma.PharmAccountUpdateOneRequiredWithoutSessionsNestedInput
}
...
export type AuthSessionOmit<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = runtime.Types.Extensions.GetOmit<"tokenHash" | "accountId" | "expiresAt" | "createdAt", ExtArgs["result"]["authSession"]>
...
export interface AuthSessionDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
   ...
   * const authSessionWithTokenHashOnly = await prisma.authSession.findMany({ select: { tokenHash: true } })
   * 
   */
   ...
   * })
   * 
   * // Create many AuthSessions and only return the `tokenHash`
   * const authSessionWithTokenHashOnly = await prisma.authSession.createManyAndReturn({
   ...
   * })
   * 
   * // Update zero or more AuthSessions and only return the `tokenHash`
   * const authSessionWithTokenHashOnly = await prisma.authSession.updateManyAndReturn({
   *   select: { tokenHash: true },
   *   where: {
   *     // ... provide filter here
   *   },
