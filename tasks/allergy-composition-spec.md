...
- `src/server/db/` — ingredient, member allergy, product composition, and catalog persistence.
- `src/server/composition/` — trusted-source lookup, validation, normalization, and background enrichment.
