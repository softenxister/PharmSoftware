...
- [x] Migration contract
  ...
  - Verify: `docs/planning/react-router-vite-migration-spec.md` covers all current routes and endpoints.
...
- [x] Member CSV contract
  ...
  - Files: `server/import/memberDataMigration.ts`, upload module, colocated tests.
...
- [x] Evidence-producing classifier
  ...
  - Files: `server/import/productCategoryNormalization.ts` and its test.
...
- [x] Complete-catalog preview
  ...
  - Files: `scripts/data-maintenance/normalize-product-categories.ts`.
